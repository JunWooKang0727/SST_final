...
<script type="text/javascript">
	...
	function sendRegData(){
		$.ajax({
			type: "POST",
			url: "/question/create",
			data: {q_contents:$(".input_contents").html(),q_title:$(".input_title").val(),q_writer:"kang"},
			async:"true",
			success: function(){
					...
					<div class="row">
						...
						<form action="Question_InsertAction.do" method="post">
							...
							<div class="input_title_wrap">
								<textarea class="input_title" placeholder="제목을 입력하세요" name="q_title"></textarea>
							</div>
...
<!-- 							<select id="hiliteColor">
							...
							<div class="formBtnWrap">
								...
								<a id="submit" href="/question/create" 
