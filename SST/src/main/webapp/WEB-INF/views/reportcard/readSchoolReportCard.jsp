			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<input type="hidden" id="rc-type" value="${reportcard.rc_type}">
						<input type="hidden" id="rc-subtype" value="${reportcard.rc_subtype}">
					</div>
					<!-- Content Row -->
					<div class="row">
						<div class="col-lg-12">
						...
						<div class="col-lg-12">
							<div class="card shadow mb-4">
								...
								<div class="collapse show" id="collapseCardExample">
									...
									<a class="btn btn-success btn-circle" href="/reportcard/schooltest/create?rc_num=${reportcard.rc_num}">
