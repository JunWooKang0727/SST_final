...
<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			id="userDropdown" role="button" data-toggle="collapse"
			data-target="#topbars" aria-haspopup="true" aria-expanded="true"
			aria-controls="collapsePages"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">
					${sessionScope.loginsession.id } </span> <img
				class="img-profile rounded-circle" src="../img/undraw_profile.svg">
		</a> <!-- Dropdown - User Information -->
			<div id="topbars"
				class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
				aria-labelledby="userDropdown">
				<a class="ml-4 collapse-item" href="/SST/member/mypage.do"> <i
					class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> 마이페이지
				</a><br> <a class="ml-4 collapse-item" href="#"> <i
				...
				<a class="ml-4 collapse-item" href="/SST/member/logout.do"> <i
